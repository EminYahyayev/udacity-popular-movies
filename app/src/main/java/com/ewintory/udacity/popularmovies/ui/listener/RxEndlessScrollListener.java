 ...
 */
public abstract class RxEndlessScrollListener extends RecyclerView.OnScrollListener {
    ...
    public RxEndlessScrollListener() {}

    public RxEndlessScrollListener(int visibleThreshold) {
        this.visibleThreshold = visibleThreshold;
    }

    public RxEndlessScrollListener(int visibleThreshold, int startPage) {
        this.visibleThreshold = visibleThreshold;
        this.startingPageIndex = startPage;
        this.currentPage = startPage;
    }

    public RxEndlessScrollListener setInverted(boolean inverted) {
        this.inverted = inverted;
        return this;
    }

    public RxEndlessScrollListener setCallback(OnLoadMoreCallback callback) {
        mCallback = callback;
        return this;
    }
    ...
    public static RxEndlessScrollListener fromGridLayoutManager(
            @NonNull final GridLayoutManager layoutManager,
            int visibleThreshold,
            int startPage) {

        return new RxEndlessScrollListener(visibleThreshold, startPage) {
    ...
    public static RxEndlessScrollListener fromLinearLayoutManager(
